...
gs = {
	...
	show: function () {
		...
		if (newwidthdisplay != 'block') {
			...
			newgsstyles.href = "https://get.gridsetapp.com/38058/";
	...
	buildgrid: function (area, j, showgrid) {
		...
		var set = JSON.parse('{"id":"38058","name":"D","grids":{"d":{"name":"Desktop","prefix":"d","rangeMin":"990","rangeMax":"none","columns":{"d1":{"name":"d1","unit":null,"percent":41.21212121,"px":408},"d2":{"name":"d2","unit":null,"percent":1.41414141,"px":14},"d3":{"name":"d3","unit":null,"percent":2.62626262,"px":26},"d4":{"name":"d4","unit":null,"percent":4.34343434,"px":43},"d5":{"name":"d5","unit":null,"percent":3.93939393,"px":39},"d6":{"name":"d6","unit":null,"percent":1.01010101,"px":10},"d7":{"name":"d7","unit":null,"percent":9.09090909,"px":90},"d8":{"name":"d8","unit":null,"percent":9.09090909,"px":90},"d9":{"name":"d9","unit":null,"percent":9.09090909,"px":90},"d10":{"name":"d10","unit":null,"percent":9.09090909,"px":90}},"gutter":{"unit":null,"px":10,"percent":1.01010101},"ratio":{"name":"1","value":null}}},"prefixes":{"index":["d"]}}'),
